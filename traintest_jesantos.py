...
model_name          = 'cellnet_test'
create_new_folder   =  False

num_gpus            = 1
batch_size          = 10
total_samples4train = 200
epochs              = 500
image_dims          = (560,640)
...
###### We are going to drop the first channel of y because we don't need background info anymore
y_train = y_train[:,:,:,1:]
masks/=255
